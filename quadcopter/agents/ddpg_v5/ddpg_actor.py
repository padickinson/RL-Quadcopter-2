...
class Actor:
    ...
    def build_model(self):
        ...
        # Add hidden layers
        net = layers.Dense(units=400, kernel_initializer=w_init, bias_initializer=w_init, activation='relu')(states)
        ...
        actions = layers.Lambda(lambda x: (x * self.action_range/2.0) + self.action_low,
